...
[`docs/agent-rules-reference.md`](agent-rules-reference.md#3-session-start-run-once-at-every-session-start) section 3 is the authoritative behavioral contract for session start.
