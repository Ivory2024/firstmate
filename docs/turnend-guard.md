...
This is the authoritative current contract for the "no turn ends blind" primary backstop referenced from [`docs/agent-rules-reference.md`](agent-rules-reference.md#8-supervision-protocol) section 8.
