---
name: stow
description: Sweep the session for durable knowledge and file it to disk, then curate bounded startup memory before reset. Use on `/stow` (e.g. "/stow", "stow what you've learned"), before a context reset, or periodically.
user-invocable: true
metadata:
  internal: true
---
