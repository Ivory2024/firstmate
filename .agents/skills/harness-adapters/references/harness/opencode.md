...
| Candidate preference | Prefer a free model family already validated elsewhere when it meets the privacy and capability requirements. Jev 1.13 Free is in the Jev 1.13 family already verified by Firstmate; see the `jev-tools-adoption` entry in `data/learnings.md`. |
