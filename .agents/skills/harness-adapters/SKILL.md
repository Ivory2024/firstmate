...
description: Operate or recover supported Firstmate harnesses (claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, agy) before spawning, steering, interrupting, or verifying workers.
