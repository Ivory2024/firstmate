...
This skill is the single owner of the completion-aware profile-array selection procedure, including malformed-config refusal, every-candidate accounting, and strongest-reasoning/tie safety rules.
`AGENTS.md` section 4 owns only the always-loaded intake boundary, routing precedence, and load trigger.
