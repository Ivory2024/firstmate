...
description: Resolve FM_HOME paths and ownership before inspecting, debugging, or hand-writing a path for a file or directory that AGENTS.md section 2 does not already name.
user-invocable: false
metadata:
  internal: true
---

# firstmate-layout-reference

`docs/configuration.md` remains the single owner of the top-level layout and
configuration schemas; this skill is the exhaustive per-path lookup table for
what each producing script's header and help would otherwise require reading
individually.
