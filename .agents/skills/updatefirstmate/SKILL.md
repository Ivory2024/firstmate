...
description: Update Firstmate and secondmates safely from origin on `/updatefirstmate` (e.g. "update firstmate", "pull the latest firstmate"), then refresh instruction surfaces.
user-invocable: true
metadata:
  internal: true
---
