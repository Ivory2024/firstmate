...
Follow the process-event operating contract in [`docs/configuration.md`](../../../docs/configuration.md#process-to-event-sources-stateprocevent) when recovering a worker that hosts a board.
