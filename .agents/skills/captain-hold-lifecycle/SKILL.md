...
description: Close investigations, visual reviews, and captain-held decisions without losing unresolved calls. Load before treating an investigation, scout report, structured review, or Lavish review as complete; before ending a visual review that exposed a decision; when recording the captain's answer; and on any RECORD DIVERGENCE line the wake drain prints.
