...
EOF
  ...
  # 5. landed, cleanup due: the durable merge marker says the recorded PR
  # landed, but the worker's task record remains live. Cleanup waits until the
  # return gate clears; this listing does not perform a teardown.
